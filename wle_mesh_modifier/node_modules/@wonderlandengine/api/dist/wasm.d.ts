...
type XRRequestSessionFunc = (mode: XRSessionMode, requiredFeatures: string[], optionalFeatures: string[]) => Promise<XRSession>;
/**
...
export declare class WASM {
     ...
     * @note This api is meant to be used internally.
     */
    readonly webxr_request_session_func: XRRequestSessionFunc;
    /**
     ...
     */
    _registerComponentLegacy(typeName: string, params: {
        [key: string]: ComponentProperty;
    }, object: ComponentProto): number;
    /**
     ...
     * @returns The registration index.
     */
    _registerComponent(ctor: ComponentConstructor, recursive?: boolean): number;
    /**
    ...
    _wl_load_scene: (ptr: number) => void;
    ...
    _wl_physx_update: (delta: number) => void;
    ...
    _wl_mesh_create: (indicesPtr: number, indicesSize: number, indexType: number, vertexCount: number, skinned: boolean) => number;
    ...
    /** @deprecated */
    _wl_material_get_shader: (id: number) => number;
