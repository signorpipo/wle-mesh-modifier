 ...
 */
export declare class CursorTarget extends Component {
    static TypeName: string;
    static Properties: {};
    /** Emitter for events when the target is hovered */
    onHover: Emitter<[Object3D, Cursor]>;
    /** Emitter for events when the target is unhovered */
    onUnhover: Emitter<[Object3D, Cursor]>;
    /** Emitter for events when the target is clicked */
    onClick: Emitter<[Object3D, Cursor]>;
    /** Emitter for events when the cursor moves on the target */
    onMove: Emitter<[Object3D, Cursor]>;
    /** Emitter for events when the user pressed the select button on the target */
    onDown: Emitter<[Object3D, Cursor]>;
    /** Emitter for events when the user unpressed the select button on the target */
    onUp: Emitter<[Object3D, Cursor]>;
    /**
     ...
     *    this.onHover.add(f);
     */
    addHoverFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeHoverFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    addUnHoverFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeUnHoverFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     *    this.onClick.add(f);
     */
    addClickFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeClickFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    addMoveFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeMoveFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    addDownFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeDownFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    addUpFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
    /**
     * @deprecated Use the emitter instead.
     *
     * @example
     ...
     */
    removeUpFunction(f: (object?: Object3D, cursor?: Cursor) => void): void;
}
